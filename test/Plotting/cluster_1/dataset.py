...
for j in ["3_1"]:#[2, 3, 4]:
    ...
    for i in range(0, 21, 5):
        ...
        total_time_taken_df['received'].append (((row_N.time_received-row_0.time_received)  /1000)/28939)
        total_time_taken_df['consumed'].append (((row_N.node_received-row_0.node_received)  /1000)/28939)
        total_time_taken_df['completed'].append(((row_N.node_completed-row_0.node_completed)/1000)/28939)
