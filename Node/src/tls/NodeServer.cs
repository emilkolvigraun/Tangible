...
namespace Node
{
    public sealed class NodeServer
    {
        ...
        public static void RunServer()
        {
            ...
            listener.Server.ReceiveTimeout = Params.CONNECT_TIMEOUT;
            listener.Server.SendTimeout = Params.CONNECT_TIMEOUT;
            listener.Start();
            ...
            Logger.Log("NodeServer",  "Server stopped running.", Logger.LogLevel.FATAL);
        }
