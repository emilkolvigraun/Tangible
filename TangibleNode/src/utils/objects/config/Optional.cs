namespace TangibleNode
{
    class Optional 
    {
        ...
        public int Heartbeat_MS {get; set;} = Params.GetIntOrSet("HEARTBEAT_MS", -1, 4500);
        public int MaxRetries {get; set;} = Params.GetIntOrSet("MAX_RETRIES", -1, 4);
        public int Timeout_MS {get; set;} = Params.GetIntOrSet("TIMEOUT", -1, 1000);
